...
-- =====================================================
-- JECHO INTRO + KEY SYSTEM (WORKING VERSION)
-- =====================================================
...
IntroText.Text = "Jecho On Top Baby"
...
IntroMusic.SoundId = "rbxassetid://1843529636"
IntroMusic.Volume = 1
IntroMusic.Looped = true

TweenService:Create(BlackFrame,TweenInfo.new(0.8),{BackgroundTransparency=0}):Play()
task.wait(0.4)
...
IntroText.Text = "BAKAJAINO!!!"

TweenService:Create(IntroText,TweenInfo.new(0.5),{TextTransparency=0}):Play()
task.wait(0.6)

-- SHAKE EFFECT
local originalPos = IntroText.Position
for i = 1, 35 do
	IntroText.Position = originalPos + UDim2.new(0, math.random(-20,20), 0, math.random(-20,20))
	task.wait(0.02)
end
IntroText.Position = originalPos
...
local function PlayEmote(name, id)
	...
	if LocalPlayer.Character.Humanoid.RigType ~= Enum.HumanoidRigType.R6 then
		...
		SendNotification(
			"r6?",
			"switch to r15 to be able to use emotes"
		)
	end
end
